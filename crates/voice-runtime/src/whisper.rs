...
pub use crate::zipformer::{
    ZipformerConfig as WhisperConfig, ZipformerRecognizer as WhisperRecognizer,
};

#[cfg(all(feature = "whisper", not(feature = "zipformer")))]
mod legacy {
    ...
    impl WhisperRecognizer {
        ...
        fn transcribe_blocking(&self, utterance: Utterance) -> Result<Transcript, SttError> {
            ...
            Ok(Transcript {
                ...
                engine: "whisper.cpp/legacy".into(),
...
#[cfg(all(feature = "whisper", not(feature = "zipformer")))]
pub use legacy::{WhisperConfig, WhisperRecognizer};
